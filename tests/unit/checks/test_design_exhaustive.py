...
class TestDesignCheckerExhaustive(unittest.TestCase, CheckerTestCase):
    ...
    def test_visit_return_naked_return_raw_type(self):
    ...
    def test_visit_assign_missing_abstraction(self):
    ...
    def test_defensive_none_check_in_domain(self):
    ...
    def test_any_in_signature_recursive(self):
