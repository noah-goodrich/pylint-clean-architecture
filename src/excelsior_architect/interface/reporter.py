...
class CleanArchitectureSummaryReporter(BaseReporter):
    ...
    def __init__(self, output: Any | None = None) -> None:  # pylint: disable=banned-any-usage
    ...
    def _collect_stats(self) -> tuple[dict[str, dict[str, str | int]], set[str]]:
        """Aggregate error statistics."""
        errors: dict[str, dict[str, str | int]] = defaultdict(lambda: defaultdict(int))
    ...
    def _calculate_widths(
        self,
        headers: list[str],
        errors: dict[str, dict[str, str | int]],
