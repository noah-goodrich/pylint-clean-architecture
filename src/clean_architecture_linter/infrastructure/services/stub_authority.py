...
Search order:
  1. Bundled stubs shipped with the package (clean_architecture_linter/stubs/)
...
from clean_architecture_linter.domain.protocols import StubAuthorityProtocol
...
class StubAuthority(StubAuthorityProtocol):
    ...
    def __init__(self, stubs_root: Optional[Path] = None) -> None:
    ...
    def _find_stubs_dirs(self, project_root: Optional[str] = None) -> list[Path]:
